// exp_main
// Old-New Experiment Version 1: ID
...
function buildTestTrials(testStimuli_block, currentBlock) {
  ...
  testStimuli_block.forEach((stim, index) => {
    ...
    const judgmentTrial = {
      type: jsPsychHtmlKeyboardResponse,
      stimulus: function() {
        let html = '<p style="font-size: 24px; margin-bottom: 20px;">Was this Person shown in the study phase?</p>';
        html += '<div style="display: flex; justify-content: center; width: 100%;">';
      ...
      on_load: function() {
        ...
        buttons.forEach(button => {
          button.addEventListener('click', function() {
            ...
            const normalizedTrueCondition = (trueCondition === "old-old" || trueCondition === "old-new") ? "old" : "new";
...
const summary_data = {
  ...
  func: function() {
    ...
    testData.forEach(trial => {
      ...
      const isOldStim = (trueCondition === "old-old" || trueCondition === "old-new");
      const isNewStim = (trueCondition === "new");
...
async function startExperiment() {
  ...
  const instruction_list = [
    'exp_files/img/Instruction_v1/Start.png',
    'exp_files/img/Instruction_v1/Demo.png',
    'exp_files/img/Instruction_v1/Learn.png',
    'exp_files/img/Instruction_v1/Test.png',
    'exp_files/img/Instruction_v1/End.png'
  ];
  ...
  const instructionStart = {
    type: jsPsychImageKeyboardResponse,
    stimulus: 'exp_files/img/Instruction_v1/Start.png',
    stimulus_height: 600,
    choices: [' '], 
    record_data: false
  };
  ...
  const instructionDemo = {
    type: jsPsychImageKeyboardResponse,
    stimulus: 'exp_files/img/Instruction_v1/Demo.png',
    stimulus_height: 500,
    choices: [' '], 
    record_data: false
  };
  ...
  const instructionLearn = {
    type: jsPsychImageKeyboardResponse,
    stimulus: 'exp_files/img/Instruction_v1/Learn.png',
    stimulus_height: 600,
    choices: [' '], 
    record_data: false
  };
  ...
  const instructionTest = {
    type: jsPsychImageKeyboardResponse,
    stimulus: 'exp_files/img/Instruction_v1/Test.png',
    stimulus_height: 600,
    choices: [' '], 
    record_data: false
  };
  ...
  const instructionEnd = {
    type: jsPsychImageKeyboardResponse,
    stimulus: 'exp_files/img/Instruction_v1/End.png',
    stimulus_height: 600,
    choices: [' '], 
    record_data: false
  };
